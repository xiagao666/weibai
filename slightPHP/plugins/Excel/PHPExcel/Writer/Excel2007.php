    ...
    public function save($pFilename = null)
    {
        if ($this->spreadSheet !== null) {
            ...
            for ($i = 0; $i < $this->spreadSheet->getSheetCount(); ++$i) {
                $this->stringTable = $this->getWriterPart('StringTable')->createStringTable($this->spreadSheet->getSheet($i),
                    $this->stringTable);
            }
            ...
            for ($i = 0; $i < $this->spreadSheet->getSheetCount(); ++$i) {
                ...
                if (($drawingCount > 0) || ($chartCount > 0)) {
                    ...
                    $objZip->addFromString('xl/drawings/drawing' . ($i + 1) . '.xml',
                        $this->getWriterPart('Drawing')->writeDrawings($this->spreadSheet->getSheet($i), $chartRef2,
                            $this->includeCharts));
                }
